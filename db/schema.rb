...
ActiveRecord::Schema.define(version: 20160201190945) do
  ...
  create_table "scraped_categories", force: true do |t|
  ...
  create_table "scraped_categories_products", force: true do |t|
    t.integer "scraped_product_id"
    t.integer "scraped_category_id"
  end

  create_table "scraped_products", force: true do |t|
    t.integer  "manufacturer_id"
  ...
  add_index "scraped_products", ["manufacturer_id", "code"], name: "index_scraped_products_on_manufacturer_id_and_code", using: :btree
  add_index "scraped_products", ["manufacturer_id"], name: "index_scraped_products_on_manufacturer_id", using: :btree

  create_table "scraped_variants", force: true do |t|
    t.integer  "scraped_product_id"
  ...
  add_index "spree_addresses", ["tenant_id"], name: "index_spree_addresses_on_tenant_id", using: :btree
  ...
  add_index "spree_adjustments", ["tenant_id"], name: "index_spree_adjustments_on_tenant_id", using: :btree
  ...
  add_index "spree_assets", ["tenant_id"], name: "index_spree_assets_on_tenant_id", using: :btree
  ...
  add_index "spree_calculators", ["tenant_id"], name: "index_spree_calculators_on_tenant_id", using: :btree
  ...
  add_index "spree_configurations", ["tenant_id"], name: "index_spree_configurations_on_tenant_id", using: :btree
  ...
  add_index "spree_countries", ["tenant_id"], name: "index_spree_countries_on_tenant_id", using: :btree
  ...
  add_index "spree_credit_cards", ["tenant_id"], name: "index_spree_credit_cards_on_tenant_id", using: :btree
  ...
  add_index "spree_inventory_units", ["tenant_id"], name: "index_spree_inventory_units_on_tenant_id", using: :btree
  ...
  add_index "spree_line_items", ["tenant_id"], name: "index_spree_line_items_on_tenant_id", using: :btree
  ...
  add_index "spree_log_entries", ["tenant_id"], name: "index_spree_log_entries_on_tenant_id", using: :btree
  ...
  add_index "spree_option_types", ["tenant_id"], name: "index_spree_option_types_on_tenant_id", using: :btree
  ...
  add_index "spree_option_values", ["tenant_id"], name: "index_spree_option_values_on_tenant_id", using: :btree
  ...
  add_index "spree_orders", ["tenant_id"], name: "index_spree_orders_on_tenant_id", using: :btree
  ...
  add_index "spree_payment_capture_events", ["tenant_id"], name: "index_spree_payment_capture_events_on_tenant_id", using: :btree
  ...
  add_index "spree_payment_methods", ["tenant_id"], name: "index_spree_payment_methods_on_tenant_id", using: :btree
  ...
  add_index "spree_payments", ["tenant_id"], name: "index_spree_payments_on_tenant_id", using: :btree
  ...
  add_index "spree_preferences", ["key"], name: "index_spree_preferences_on_key", using: :btree
  add_index "spree_preferences", ["tenant_id"], name: "index_spree_preferences_on_tenant_id", using: :btree
  ...
  add_index "spree_product_option_types", ["tenant_id"], name: "index_spree_product_option_types_on_tenant_id", using: :btree
  ...
  add_index "spree_product_properties", ["tenant_id"], name: "index_spree_product_properties_on_tenant_id", using: :btree
  ...
  add_index "spree_products", ["tenant_id"], name: "index_spree_products_on_tenant_id", using: :btree
  ...
  add_index "spree_promotion_action_line_items", ["tenant_id"], name: "index_spree_promotion_action_line_items_on_tenant_id", using: :btree
  ...
  add_index "spree_promotion_actions", ["tenant_id"], name: "index_spree_promotion_actions_on_tenant_id", using: :btree
  ...
  add_index "spree_promotion_rules", ["tenant_id"], name: "index_spree_promotion_rules_on_tenant_id", using: :btree
  ...
  add_index "spree_promotions", ["tenant_id"], name: "index_spree_promotions_on_tenant_id", using: :btree
  ...
  add_index "spree_properties", ["tenant_id"], name: "index_spree_properties_on_tenant_id", using: :btree
  ...
  add_index "spree_prototypes", ["tenant_id"], name: "index_spree_prototypes_on_tenant_id", using: :btree
  ...
  add_index "spree_return_authorizations", ["tenant_id"], name: "index_spree_return_authorizations_on_tenant_id", using: :btree
  ...
  add_index "spree_roles", ["tenant_id"], name: "index_spree_roles_on_tenant_id", using: :btree
  ...
  add_index "spree_shipments", ["tenant_id"], name: "index_spree_shipments_on_tenant_id", using: :btree
  ...
  add_index "spree_shipping_categories", ["tenant_id"], name: "index_spree_shipping_categories_on_tenant_id", using: :btree
  ...
  add_index "spree_shipping_method_categories", ["tenant_id"], name: "index_spree_shipping_method_categories_on_tenant_id", using: :btree
  ...
  add_index "spree_shipping_methods", ["tenant_id"], name: "index_spree_shipping_methods_on_tenant_id", using: :btree
  ...
  add_index "spree_shipping_rates", ["tenant_id"], name: "index_spree_shipping_rates_on_tenant_id", using: :btree
  ...
  add_index "spree_state_changes", ["tenant_id"], name: "index_spree_state_changes_on_tenant_id", using: :btree
  ...
  add_index "spree_states", ["tenant_id"], name: "index_spree_states_on_tenant_id", using: :btree
  ...
  add_index "spree_stock_movements", ["tenant_id"], name: "index_spree_stock_movements_on_tenant_id", using: :btree
  ...
  add_index "spree_tax_categories", ["tenant_id"], name: "index_spree_tax_categories_on_tenant_id", using: :btree
  ...
  add_index "spree_tax_rates", ["tenant_id"], name: "index_spree_tax_rates_on_tenant_id", using: :btree
  ...
  add_index "spree_taxonomies", ["tenant_id"], name: "index_spree_taxonomies_on_tenant_id", using: :btree
  ...
  add_index "spree_taxons", ["tenant_id"], name: "index_spree_taxons_on_tenant_id", using: :btree
  ...
  create_table "spree_tenants", force: true do |t|
    t.string   "domain"
    t.string   "code"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "spree_trackers", ["tenant_id"], name: "index_spree_trackers_on_tenant_id", using: :btree
  ...
  add_index "spree_users", ["tenant_id"], name: "index_spree_users_on_tenant_id", using: :btree
  ...
  add_index "spree_variants", ["tenant_id"], name: "index_spree_variants_on_tenant_id", using: :btree
  ...
  add_index "spree_zone_members", ["tenant_id"], name: "index_spree_zone_members_on_tenant_id", using: :btree
  ...
  add_index "spree_zones", ["tenant_id"], name: "index_spree_zones_on_tenant_id", using: :btree
