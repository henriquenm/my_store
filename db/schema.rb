...
ActiveRecord::Schema.define(version: 20160202121416) do
  ...
  create_table "scraped_categories", force: :cascade do |t|
  ...
  create_table "scraped_categories_products", force: :cascade do |t|
    t.integer "scraped_product_id",  limit: 4
    t.integer "scraped_category_id", limit: 4
  end
  ...
  create_table "scraped_variants", force: :cascade do |t|
    t.integer  "scraped_product_id", limit: 4
    t.string   "sku",                limit: 20,                                        null: false
    t.string   "sku_name",           limit: 255
